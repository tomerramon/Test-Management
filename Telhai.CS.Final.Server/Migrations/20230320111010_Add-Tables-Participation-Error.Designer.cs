...
namespace Telhai.CS.Final.Server.Migrations
{
    ...
    [Migration("20230320111010_Add-Tables-Participation-Error")]
    partial class AddTablesParticipationError
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Telhai.CS.Final.Server.Models.Participation", b =>
                {
                    ...
                    b.Property<string>("Strudent_Name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "Strudent_Name");
                    ...
                    b.HasAnnotation("Relational:JsonPropertyName", "Participation");
                });
